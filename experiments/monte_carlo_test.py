...
class MonteCarloSimulator:
    ...
    def process(self):
        ...
        for _step, _expense in enumerate(self._expenses):
            ...
            else:  # if we have a positive balance, adjust by average return
                self._balance *= 1.0 + _avg_return
...
if __name__ == "__main__":
    ...
    for _i in range(10000):
        ...
        _results.append(_sim.get_balances())
        # if DEBUG:
        #    print(stats(_sim))
    # print(_sim.get_balances())

    print("Percent Success: ", 100.0 * _success / 10000.0)
    print("Failure Stats: %s" % stats(_failure_step))
