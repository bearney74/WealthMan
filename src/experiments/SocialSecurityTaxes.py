class SocialSecurityTaxes:
    def __init__(self, AGI: int, SS_Amount: int):
        self._SS_income = SS_Amount
        self._income = AGI + int(SS_Amount / 2)
        self._taxable = None

        # assume filing joint right now..
        self._filing_status = "JOINT"
