...
class ProvisionalIncomeTest(unittest.TestCase):
    ...
    def test_single_status(self):
        ...
        self.assertEqual(_p.calc_ss_taxable(20_000, 15_000), int(.50 * 15_000)) 
        
        self.assertEqual(_p.get_rate(30_000, 15_000), 85.0)
        self.assertEqual(_p.calc_ss_taxable(30_000, 15_000), int(.85 * 15_000)) 
    ...
    def test_married_status(self):
        ...
        self.assertEqual(_p.calc_ss_taxable(30_000, 16_000), int(.50 * 16_000)) 
        
        self.assertEqual(_p.get_rate(40_000, 15_000), 85.0)
        self.assertEqual(_p.calc_ss_taxable(40_000, 17_000), int(.85 * 17_000)) 
