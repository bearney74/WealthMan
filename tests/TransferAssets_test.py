...
class TransferAssetTest(unittest.TestCase):
    ...
    def test_TransferAssetsIRA2Roth(self):
        _src=TraditionalIRA(Name="Trad IRA", Owner=AccountOwnerType.Client,
                            BirthDate=date(1990, 1, 1), Balance=1000, InterestRate=1.0)
        
        _tgt=RothIRA(Name="Roth IRA", Owner=AccountOwnerType.Client,
                     BirthDate=date(1990, 1, 1), Balance=500, InterestRate=2.0)
    ...
    def test_TransferAssetsIRA2Brokerage(self):
        ...
        _tgt=Brokerage(Name="Roth IRA", Owner=AccountOwnerType.Client,
                     BirthDate=date(1990, 1, 1), Balance=500, InterestRate=2.0)
    ...
    def test_TransferAssetsRoth2Brokerage(self):
        _src=RothIRA(Name="Trad IRA", Owner=AccountOwnerType.Client,
                            BirthDate=date(1990, 1, 1), Balance=1000, InterestRate=1.0)
    ...
    def test_TransferAssetsBrokerage2Brokerage(self):
        _src=Brokerage(Name="Brokerage", Owner=AccountOwnerType.Client,
                            BirthDate=date(1990, 1, 1), Balance=1000,
                            InterestRate=1.0)
        
        _tgt=Brokerage(Name="Cash", Owner=AccountOwnerType.Client,
                     BirthDate=date(1990, 1, 1), Balance=500, InterestRate=2.0)
